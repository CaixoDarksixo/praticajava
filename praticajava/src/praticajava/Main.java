...
public Main(){
	...
	Button createskill = new Button(6, 110, 108, 20, "CreateSkill", "", null);
	Main.buttons.add(createskill);
	
	Button changepfp = new Button(10, 0, 16, 16, "ChangePfpPlus", "", null);
	Main.buttons.add(changepfp);
	Button changepfp2 = new Button(26, 0, 16, 16, "ChangePfpMinus", "", null);
