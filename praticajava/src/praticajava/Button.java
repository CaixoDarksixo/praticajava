...
public class Button {
	...
	public Button(int x, int y, int width, int height, String function, String skill, Skill parent) {
	...
	public void execute() {
		...
		case "CreateSkill":
			...
			int[] none = {0};
			Skill nskill = new Skill( JOptionPane.showInputDialog(Main.frame, "Nome da habilidade:"),50,150,0,0,none);
	...
	public void render(Graphics g) {
		switch(function) {
		case "ChangeBackgroundPlus":
			g.drawImage(backgroundbutton[0],x,y+parent.getArrayPosition()*70-(int)Main.cameray,null);
		break;
		case "ChangeBackgroundMinus":
			g.drawImage(backgroundbutton[1],x,y+parent.getArrayPosition()*70-(int)Main.cameray,null);
		break;
		case "CreateSkill":
			g.drawImage(newskillbutton,x,y-(int)Main.cameray,null);
		break;
		case "DeleteSkill":
			g.drawImage(deleteskillbutton,x,y+parent.getArrayPosition()*70-(int)Main.cameray,null);
		break;
		case "ChangePfpPlus":
