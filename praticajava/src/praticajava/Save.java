...
public class Save {
	...
	public static void saveState(List<Skill> skills) {
		...
		for(int i = 0; i < skills.size(); i++) {
			String current = ""+skills.get(i).getSkill()+"xhx"+skills.get(i).getX()+"xhx"+skills.get(i).getY()+"xhx"+skills.get(i).getLevel()+"xhx"+skills.get(i).getBgIndex();
	...
	public static String loadSave() {
		...
		if(file.exists()) {
			...
			}catch(FileNotFoundException e) { System.out.println("Save n existe");}
		}
